...
ispy.detector_description = {
	...
	fn: ispy.makeModelTrackerEndcap, style: {color: "rgb(100%, 100%, 0%)", altColor: "rgb(70%, 70%, 0%)", opacity: 0.5, linewidth: 0.5},
	threed: true, rphi: false, rhoz: true
    },
    "TrackerBarrel3D_MODEL": {
	type: ispy.MODEL, on: false, group: "Detector", name: "Tracker Barrels",
	fn: ispy.makeModelTrackerBarrel, style: {color: "rgb(100%, 100%, 0%)", altColor: "rgb(70%, 70%, 0%)", opacity: 0.5, linewidth: 0.5},
	threed: true, rphi: false, rhoz: false
    },
    "TrackerRPhi_V1": {
	type: ispy.BOX, on: true, group: "Detector", name:"Tracker RPhi",
	fn: ispy.makeTrackerPiece, style: {color: "rgb(100%, 100%, 0%)", altColor: "rgb(70%, 70%, 0%)", opacity: 0.5, linewidth: 0.5},
	threed: false, rphi: true, rhoz: false
    },
    "TrackerRZ_V1": {
...
ispy.event_description = {
    ...
    "Photons_V1": {
	type: ispy.LINE, on: false, group: "Physics", name: "Photons (Reco)",
	fn: ispy.makePhoton, style: {color: "rgb(80%, 80%, 0%)", opacity: 1.0, linewidth: 1}
    },
    "PATPhotons_V1": {
	type: ispy.LINE, on: false, group: "Physics", name: "Photons (PAT)",
	fn: ispy.makePhoton, style: {color: "rgb(80%, 80%, 0%)", opacity: 1.0, linewidth: 1}
    },
    "GlobalMuons_V1": {
	type: ispy.ASSOC, on: true, group: "Physics", name: "Global Muons (Reco)",
	extra: "Points_V1", assoc: "MuonGlobalPoints_V1",
	fn: ispy.makeTrackPoints, style: {color: "rgb(100%, 0%, 0%)", opacity: 1.0, linewidth: 2}, selection:{"min_pt":1.0, "index":0}
    },
    "GlobalMuons_V2": {
	type: ispy.ASSOC, on: true, group: "Physics", name: "Global Muons (Reco)",
	extra: "Points_V1", assoc: "MuonGlobalPoints_V1",
	...
	fn: ispy.makeTracks, style: {color: "rgb(10%, 100%, 10%)", opacity: 0.9, linewidth: 2}, selection: {"min_pt":0.0, "index":0}
    },
    "GsfElectrons_V2": {
	type: ispy.ASSOC, on: true, group: "Physics", name: "Electron Tracks (GSF)",
	extra: "Extras_V1", assoc: "GsfElectronExtras_V1",

...
yae.makeModelTrackerBarrel = function() {
...
yae.makeModelTrackerEndcap = function() {
...
yae.data_description = {
  ...
  /*
  "EcalBarrel3D_MODEL": {type: yae.MODEL, on: true, group: "Detector", desc: "ECAL Barrel",
    fn: makeModelEcalBarrel, style: {color: [0, 1, 1], opacity: 0.5, linewidth: 0.5}},
  "EcalEndcap3D_plus": {type: yae.MODEL, on: false, group: "Detector", desc: "ECAL Endcap (+)",
    fn: makeModelEcalEndcapPlus, style: {color: [0, 1, 1], opacity: 0.5, linewidth: 0.5}},
  "EcalEndcap3D_minus": {type: yae.MODEL, on: false, group: "Detector", desc: "ECAL Endcap (-)",
    fn: makeModelEcalEndcapMinus, style: {color: [0, 1, 1], opacity: 0.5, linewidth: 0.5}},
  "HcalBarrel3D_MODEL": {type: yae.MODEL, on: false, group: "Detector", desc: "HCAL Barrel",
    fn: makeModelHcalBarrel, style: {color: [0.8, 1, 0], opacity: 0.5, linewidth: 0.5}},
  "HcalEndcap3D_MODEL": {type: yae.MODEL, on: false, group: "Detector", desc: "HCAL Endcaps",
    fn: makeModelHcalEndcap, style: {color: [0.8, 1, 0], opacity: 0.5, linewidth: 0.5}},
  "HcalOuter3D_MODEL": {type: yae.MODEL, on: true, group: "Detector", desc: "HCAL Outer",
    fn: makeModelHcalOuter, style: {color: [0.8, 1, 0], opacity: 0.5, linewidth: 0.5}},
  "HcalForward3D_plus": {type: yae.MODEL, on: false, group: "Detector", desc: "HCAL Forward (+)",
    fn: makeModelHcalForwardPlus, style: {color: [0.8, 1, 0], opacity: 0.5, linewidth: 0.5}},
  "HcalForward3D_minus": {type: yae.MODEL, on: false, group: "Detector", desc: "HCAL Forward (-)",
    fn: makeModelHcalForwardMinus, style: {color: [0.8, 1, 0], opacity: 0.5, linewidth: 0.5}},
  */
